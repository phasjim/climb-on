(function(angular) {
	...
	angular.module('portfolio', [])
		...
		.controller('Controller', ['$scope', function($scope) {
			...
			var containerScene4a = new ScrollMagic.Scene({
				triggerElement: '#trigger2',
				offset: "275%",
				duration: "100%"
		    })
			...
			var containerScene4b = new ScrollMagic.Scene({
				triggerElement: '#trigger2',
				offset: "275%",
				duration: "100%"
		    })
			...
			var containerScene4c = new ScrollMagic.Scene({
				triggerElement: '#trigger2',
				offset: "275%",
				duration: "100%"
		    })
			...
			var containerScene7a = new ScrollMagic.Scene({
			...
			var containerScene7b = new ScrollMagic.Scene({
				triggerElement: '#trigger3',
				offset: "275%",
		    })
			...
			var containerScene7c = new ScrollMagic.Scene({
				triggerElement: '#trigger3',
				offset: "275%",
		    })
